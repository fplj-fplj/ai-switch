    ...
    <section className="space-y-3">
      <div className="rounded-2xl border border-stone-200 bg-white/82 shadow-sm">
        <div className="border-b border-stone-200 px-4 py-3">
          <p className="text-[11px] font-semibold uppercase tracking-wide text-stone-400">资源库</p>
          <h1 className="mt-0.5 text-lg font-semibold text-stone-950">批量</h1>
        </div>
        <div className="p-3">
          <input
            value={search}
            onChange={(event) => setSearch(event.target.value)}
            aria-label="搜索批量、账号、供应商"
            placeholder="搜索批量、账号、供应商"
