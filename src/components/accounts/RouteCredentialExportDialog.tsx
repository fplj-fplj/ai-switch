  ...
  return (
    ...
    >
      <div
        ...
        aria-modal="true"
        className="flex max-h-full w-full max-w-2xl flex-col overflow-hidden rounded-lg border border-stone-200 bg-white shadow-2xl sm:max-h-[min(760px,calc(100vh-2rem))]"
        role="dialog"
        tabIndex={-1}
      >
